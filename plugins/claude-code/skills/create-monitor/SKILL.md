---
name: create-monitor
description: This skill should be used when the user asks to "モニターを作成", "create monitor", "監視を追加", "XXXを監視して", "XXXのHTTP監視を作って", "ヘルスチェックを設定", "add monitor", "モニターを追加", "TCP監視", "Ping監視". Creates new Manako monitors with type-specific configuration.
---

# Create Monitor

新しい Manako モニターを作成する。3 種類のモニタータイプに対応。
...
# Ping
manako monitors add example.com --name "Ping" --type ping
```
...
- チェック間隔: Free は最小 300 秒、Pro は最小 180 秒、最大 86400 秒 (24 時間)
